package com.biantech.ssmd.mvc.controller;

import com.biantech.ssmd.domain.ResponseObj;
import com.biantech.ssmd.domain.User;
import com.biantech.ssmd.service.UserService;
import com.biantech.ssmd.utils.GsonUtils;
import com.biantech.ssmd.utils.StringUtils;
...
public class UserController {
    ...
    @RequestMapping(value = "/login"
            ...
            , produces = "application/json; charset=utf-8")
    @ResponseBody
    public Object login(HttpServletRequest request, HttpServletResponse response, @RequestBody User user, HttpSession session) throws Exception {
        Object result;
        if (null == user) {
            responseObj = new ResponseObj<User>();
